...
function extractVisibility(line) {
...
function extractReturnType(line, functionName) {
...
function extractSimpleParameters(line) {
    try {
...
function createDefaultAnalysis(functionName, totalLines) {
